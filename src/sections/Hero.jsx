...
export default function Hero({ onSearch = () => {} }) {
  ...
  return (
    <section className="relative w-full min-h-[420px] md:min-h-[60vh] flex items-center justify-center overflow-hidden">
      {/* background video */}
      <video
      ...
      {/* gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-indigo-900/90 via-sky-900/80 to-slate-900/90 z-10" />

      <div className="relative z-20 w-full max-w-6xl mx-auto px-4 md:px-6 py-10 md:py-16 text-white">
        {/* heading */}
        <h2 className="text-center text-2xl md:text-4xl font-bold mb-3">
          Book cab Online
        </h2>
        <p className="text-center text-xs md:text-sm text-sky-100/80 mb-6">
          Local Trip • Outstation Trip • Airport
          Transfer
        </p>
        ...
        <form
          ...
          className="bg-white rounded-2xl shadow-2xl overflow-hidden text-sm text-slate-900"
        >
          {/* top row toggles */}
          <div className="px-4 md:px-6 py-3 md:py-4 flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 bg-slate-50/80">
            <span className="font-semibold text-slate-800 text-sm md:text-base">
              {service === "local"
                ? "Local Trip – City Rentals"
                : service === "outstation"
          ...
          {/* main form row - DIFFERENT per service */}
          {service === "local" && (
            <div className="px-4 md:px-6 py-4">
              <div className="grid grid-cols-1 md:grid-cols-6">
                {/* Pickup */}
                <div className="md:col-span-2 border-b md:border-b-0 md:border-r border-slate-200 px-1 py-2 md:py-3 relative">
                  ...
                  >
                    ...
                    {pickupOpen &&
                      pickupSug.length > 0 && (
                        <ul className="absolute left-0 right-0 top-full mt-1 max-h-64 overflow-y-auto bg-white rounded-xl shadow-xl border border-slate-200 z-50 text-sm">
                          {pickupSug.map((sug) => (
                            <li
                              key={sug.id}
                              onMouseDown={(e) => {
                              ...
                              className="cursor-pointer px-3 py-2 hover:bg-slate-50 border-b border-slate-100 last:border-b-0 flex items-center gap-2"
                            >
                ...
                {/* Package */}
                <div className="md:col-span-1 border-b md:border-b-0 md:border-r border-slate-200 px-1 py-2 md:py-3 flex flex-col justify-center">
                  <p className="text-[11px] text-slate-500 mb-1">
                    Package
                  </p>
                  <select
                ...
                {/* SEARCH button */}
                <div className="md:col-span-1 px-1 py-3 flex">
                  <button
                    type="submit"
                    className="w-full md:h-full rounded-none md:rounded-r-2xl rounded-b-2xl md:rounded-b-none bg-gradient-to-r from-rose-500 to-red-500 text-white font-semibold text-sm tracking-wide flex items-center justify-center gap-2 hover:from-rose-600 hover:to-red-600 active:scale-[0.98] transition"
                  >
                    🔍 SEARCH
                  </button>
                </div>
            ...
            <div className="px-4 md:px-6 py-4 space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-200"
                  />
                  {fromOpen && fromSug.length > 0 && (
                    <ul className="absolute left-0 right-0 top-full mt-1 max-h-56 overflow-y-auto bg-white rounded-xl shadow-xl border border-slate-200 z-50 text-sm">
                      {fromSug.map((sug) => (
                        <li
                          key={sug.id}
                          onMouseDown={(e) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div className="flex items-end">
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-rose-500 to-red-500 text-white font-semibold text-sm py-3 rounded-lg shadow-lg hover:from-rose-600 hover:to-red-600 active:scale-[0.98] transition"
                  >
                    {tripType === "oneway"
                      ? "Search One Way Cabs"
